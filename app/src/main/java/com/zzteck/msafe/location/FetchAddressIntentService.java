...
//         最后在notificationmanager中创建该通知渠道 //
     ...
     * Note: We define a {@link ResultReceiver} in * LocationActivity to process content
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
           ...
           // addresses.get(0).
        /*    Log.e("liujw","#############getCountryCode " +  addresses.get(0).getCountryCode()+ "####################addresses.get(0).getCountryName()  "+addresses.get(0).getCountryName())   ;
            Log.e("liujw","#############getCountryCode " +  addresses.get(0).getCountryCode()+ "####################addresses.get(0).getCountryName()  "+addresses.get(0).getCountryName())   ;
            Log.e("liujw","#############getCountryCode " +  addresses.get(0).getCountryCode()+ "####################addresses.get(0).getCountryName()  "+addresses.get(0).getCountryName())   ;*/
